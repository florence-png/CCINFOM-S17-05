...
public class HospitalAddPanel extends AbstractFormPanel {
    ...
    protected JPanel createForm() {
        ...
        gbc.gridy = y; formPanel.add(new JLabel("Hospital Name:"), gbc);
        gbc.gridx = 1; gbc.anchor = GridBagConstraints.WEST;
        gbc.gridy = y++; formPanel.add(txtHospitalName, gbc);
    ...
    public JTextField getTxtHospitalName() {
