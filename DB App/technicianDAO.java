...
public class TechnicianDAO{
    public void addTechnician(String lastName, String firstName, String contactNumber, Integer age, String sex, Integer donorId){
        String sql = "INSERT INTO technicians (last_name, first_name, contact_number, age, sex, donor_id, status) " + "VALUES (?, ?, ?, ?, ?, ?, 'Active')";
